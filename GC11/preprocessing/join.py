...
def preprocess(x):
    ...
    df2.to_csv("/projects/arossi/gctv2/clusterdata-2011-2/join/df4.csv",mode="a",header=False,index=False)
...
merged_df = pd.read_csv("/projects/arossi/gctv2/clusterdata-2011-2/join/df4.csv", chunksize=30000)
...
merged_dfsum.to_csv("/projects/arossi/gctv2/clusterdata-2011-2/join/sum.csv", index=False)
merged_dfmin = merged_df.groupby(['job ID']).min()
merged_dfmin.to_csv("/projects/arossi/gctv2/clusterdata-2011-2/join/min.csv", index=False)
...
final_df.to_csv("/projects/arossi/gctv2/clusterdata-2011-2/join/dataset.csv")
